...
/**
 * Web response DTO for purchase orders.
 */
public class PurchaseOrderWebResponse {
    ...
    private List<PurchaseOrderLineWebResponse> lines = new ArrayList<>();
    ...
    public List<PurchaseOrderLineWebResponse> getLines() {
        return lines;
    }

    public void setLines(List<PurchaseOrderLineWebResponse> lines) {
