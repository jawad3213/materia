...
public class ReturnCode {
    ...
    private static final String PATTERN_STRING = "^RTN-[0-9]{4}$";
    ...
    public static ReturnCode createDefault() {
        return new ReturnCode(DEFAULT_PREFIX + "-0001");
    }
    
    public static ReturnCode generateNext(String current) {
        ReturnCode id = ReturnCode.of(current);
    ...
    private void validate(String value) {
        ...
        if (!PATTERN.matcher(trimmed).matches()) {
            throw new ReturnToVendorValidationException(
                ...
                "'. Format attendu: RTN-0000 (ex: RTN-0001)"
            );
        }
    }
