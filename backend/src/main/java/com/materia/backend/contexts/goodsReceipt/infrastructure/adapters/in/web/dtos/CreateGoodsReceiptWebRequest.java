...
/** Validated web request for creating a goods receipt. */
public class CreateGoodsReceiptWebRequest extends BaseInput {

    @Pattern(regexp = "^(GR-[0-9]{4})?$", message = "Receipt code must use GR-0000 format")
    private String receiptCode;
    @NotBlank(message = "Purchase order ID is mandatory") private String purchaseOrderId;
    ...
    @NotEmpty(message = "At least one goods receipt line is required") @Valid
    private List<GoodsReceiptLineWebRequest> lines = new ArrayList<>();
