...
public class ReturnToVendorLineWebRequest {
    ...
    @NotBlank(message = "Le code du matériau est obligatoire")
    ...
    @NotNull(message = "La quantité à retourner est obligatoire")
    @Positive(message = "La quantité à retourner doit être positive")
