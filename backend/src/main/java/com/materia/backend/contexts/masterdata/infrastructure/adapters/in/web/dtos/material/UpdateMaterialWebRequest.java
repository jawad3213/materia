...
public class UpdateMaterialWebRequest {
    ...
    @Size(min = 3, max = 3, message = "Standard price currency must be exactly 3 characters if provided")
    private String standardPriceCurrency;

    @PositiveOrZero(message = "Cost price cannot be negative")
    private BigDecimal costPrice;

    @Size(min = 3, max = 3, message = "Cost price currency must be exactly 3 characters if provided")
