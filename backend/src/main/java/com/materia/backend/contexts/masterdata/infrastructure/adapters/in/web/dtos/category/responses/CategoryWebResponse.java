package com.materia.backend.contexts.masterdata.infrastructure.adapters.in.web.dtos.category.responses;
...
public class CategoryWebResponse extends BaseWebResponse {
    private UUID id;
    private String code;
    private String name;
