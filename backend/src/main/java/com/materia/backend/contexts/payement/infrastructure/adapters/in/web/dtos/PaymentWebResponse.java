...
public class PaymentWebResponse {
    ...
    private List<PaymentLineWebResponse> lines = new ArrayList<>();
    ...
    public List<PaymentLineWebResponse> getLines() { return lines; }
    public void setLines(List<PaymentLineWebResponse> lines) { this.lines = lines; }
