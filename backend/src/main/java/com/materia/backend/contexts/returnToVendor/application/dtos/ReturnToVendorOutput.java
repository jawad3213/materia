...
public class ReturnToVendorOutput extends BaseOutput {
    ...
    private List<ReturnToVendorLineOutput> lines = new ArrayList<>();
    ...
    public List<ReturnToVendorLineOutput> getLines() { return lines; }
