package com.materia.backend.contexts.masterdata.application.dtos.supplier.responses;
 ...
 */
public class SupplierResponseDto extends BaseResponse {
    ...
    public SupplierResponseDto() { super(); }
